...
export default function ShopFilter({ setProducts, products = products1 }: { setProducts: (products: any[]) => void, products?: any[] }) {
  ...
  const handleSelectAvailabilities = (availability: any) => {
  ...
  const handleSelectSizes = (size: any) => {
